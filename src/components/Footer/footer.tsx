...
const Footer: React.FC = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      label: (
        <a
          href="https://github.com/wonho-seo"
          target="_blank"
          rel="noopener noreferrer"
        >
          BE_서원호
    ...
    },
    {
      ...
      label: (
        <a
          href="https://github.com/FeelingXD"
          target="_blank"
          rel="noopener noreferrer"
        >
          BE_고지민
    ...
    },
    {
      ...
      label: (
        <a
          href="https://github.com/YouJin-Cho"
          target="_blank"
          rel="noopener noreferrer"
        >
          FE_조유진
    ...
    },
    {
      ...
      label: (
        <a
          href="https://github.com/HwangJiMinn"
          target="_blank"
          rel="noopener noreferrer"
        >
          FE_황지민
    ...
    },
    {
      ...
      label: (
        <a
          href="https://github.com/kwonseona"
          target="_blank"
          rel="noopener noreferrer"
        >
          FE_권선아
